...
def main():
    ...
    for random_state, reward_structure, n_rounds in product(
        ...
        sips = SelfNormalizedSlateStandardIPS(
            len_list=cfg.len_list, estimator_name="SIPS"
        )
        ...
        q_hat = regressor.fit_predict(
            ...
            evaluation_policy_action_dist=bandit_feedback[
    ...
    for reward_structure in reward_structure_ptn:
        ...
        plt.tight_layout()
        plt.savefig(result_dir.joinpath(f"{reward_structure}.png"))
        plt.close()
